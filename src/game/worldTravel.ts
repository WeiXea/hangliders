...
export const MAP_POIS: {
  ...
  { biome: 'city', label: 'Main Metro', u: 53, v: 53 },
  { biome: 'city', label: 'Harbor Metro', u: 60, v: 60 },
  { biome: 'city', label: 'Central Garage', u: 52, v: 52 },
  { biome: 'city', label: 'Midtown Garage', u: 56, v: 57 },
  { biome: 'city', label: 'Harbor Garage', u: 60, v: 61 },
  { biome: 'city', label: 'Secret Alleys', u: 48, v: 56 },
