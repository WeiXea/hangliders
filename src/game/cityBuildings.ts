...
export const CITY_BUILDINGS: CityBuilding[] = [
  // Bright toy-town palette — white/cream bodies, vivid shop accents (Sketchfab low-poly city vibe)
  { id: 0, x: 10, width: 9, z: 30, height: 10, color: '#f8f9fa', windows: win([true, false, true, true]), roofLandable: true, enterable: true, shop: 'CAFE', shopColor: '#e63946' },
  { id: 1, x: 33, width: 10, z: 30, height: 18, color: '#e9ecef', windows: win([false, true, true, false]), roofLandable: true, enterable: false },
  { id: 2, x: 54, width: 8, z: 30, height: 26, color: '#dee2e6', windows: win([true, true, false, true]), roofLandable: true, enterable: false },
  { id: 3, x: 76, width: 10, z: 30, height: 12, color: '#f1faee', windows: win([true, false, false, true]), roofLandable: true, enterable: true, shop: 'BOOKS', shopColor: '#2a9d8f' },
  { id: 4, x: -12, width: 7, z: 30, height: 9, color: '#fff3bf', windows: win([false, true, true, true]), roofLandable: true, enterable: true, shop: 'BURGERS', shopColor: '#e9c46a' },
  { id: 5, x: 10, width: 9, z: 54, height: 20, color: '#ced4da', windows: win([true, true, true, false]), roofLandable: true, enterable: false },
  { id: 6, x: 32, width: 7, z: 54, height: 11, color: '#f8f9fa', windows: win([false, false, true, true]), roofLandable: true, enterable: true, shop: 'PHARMACY', shopColor: '#52b788' },
  { id: 7, x: 54, width: 10, z: 74, height: 18, color: '#adb5bd', windows: win([true, true, true, true]), roofLandable: true, enterable: false },
  { id: 8, x: 76, width: 9, z: 54, height: 12, color: '#f8f9fa', windows: win([true, false, true, false]), roofLandable: true, enterable: true, shop: 'SUPERMARKET', shopColor: '#e63946' },
  { id: 9, x: 98, width: 11, z: 52, height: 22, color: '#dee2e6', windows: win([false, true, false, true]), roofLandable: true, enterable: false },
  { id: 10, x: 10, width: 6, z: 76, height: 8, color: '#ffe8d6', windows: win([true, true, false, false]), roofLandable: true, enterable: true, shop: 'BARBER', shopColor: '#e76f51' },
  { id: 11, x: 54, width: 9, z: 98, height: 12, color: '#f8f9fa', windows: win([true, false, true, true]), roofLandable: true, enterable: true, shop: 'BANK', shopColor: '#ffd60a' },
  { id: 12, x: 120, width: 10, z: 76, height: 16, color: '#ced4da', windows: win([true, true, false, true]), roofLandable: true, enterable: false },
  { id: 13, x: 152, width: 8, z: 54, height: 14, color: '#e7d6ff', windows: win([false, true, true, false]), roofLandable: true, enterable: true, shop: 'TECH', shopColor: '#7b2cbf' },
  { id: 14, x: 174, width: 10, z: 98, height: 24, color: '#adb5bd', windows: win([true, false, true, true]), roofLandable: true, enterable: false },
  { id: 15, x: 186, width: 9, z: 76, height: 10, color: '#fff0f6', windows: win([true, true, true, false]), roofLandable: true, enterable: true, shop: 'FLOWERS', shopColor: '#f72585' },
  { id: 16, x: 98, width: 7, z: 120, height: 9, color: '#f8f9fa', windows: win([false, false, true, true]), roofLandable: true, enterable: true, shop: 'SUSHI', shopColor: '#ff6b6b' },
  { id: 17, x: 120, width: 10, z: 142, height: 15, color: '#dee2e6', windows: win([true, true, false, false]), roofLandable: true, enterable: false },
  { id: 18, x: -32, width: 8, z: 30, height: 14, color: '#fff9db', windows: win([true, true, false, true]), roofLandable: true, enterable: true, shop: 'HOTEL', shopColor: '#c9a227' },
  { id: 19, x: -32, width: 10, z: 54, height: 16, color: '#ced4da', windows: win([false, true, true, true]), roofLandable: true, enterable: false },
  { id: 20, x: 32, width: 7, z: 98, height: 10, color: '#e3fafc', windows: win([true, false, true, false]), roofLandable: true, enterable: true, shop: 'GYM', shopColor: '#00b4d8' },
  { id: 21, x: 76, width: 9, z: 164, height: 20, color: '#adb5bd', windows: win([true, true, true, false]), roofLandable: true, enterable: false },
  { id: 22, x: 120, width: 8, z: 120, height: 12, color: '#fff3bf', windows: win([false, true, false, true]), roofLandable: true, enterable: true, shop: 'RADIO', shopColor: '#ff9f1c' },
  { id: 23, x: 208, width: 12, z: 98, height: 28, color: '#e9ecef', windows: win([true, true, true, true]), roofLandable: true, enterable: false },
  { id: 24, x: 208, width: 8, z: 142, height: 11, color: '#ffe3e3', windows: win([true, false, true, true]), roofLandable: true, enterable: true, shop: 'DINER', shopColor: '#e63946' },
  { id: 25, x: 32, width: 10, z: 142, height: 16, color: '#ced4da', windows: win([false, true, true, false]), roofLandable: true, enterable: false },
  { id: 26, x: 164, width: 7, z: 174, height: 9, color: '#fff4e6', windows: win([true, true, false, true]), roofLandable: true, enterable: true, shop: 'BAKERY', shopColor: '#f4a261' },
  { id: 27, x: 186, width: 9, z: 30, height: 20, color: '#dee2e6', windows: win([true, false, true, false]), roofLandable: true, enterable: false },
  { id: 28, x: -12, width: 9, z: 98, height: 12, color: '#f8f9fa', windows: win([true, true, true, false]), roofLandable: true, enterable: true, shop: 'HOSPITAL', shopColor: '#4cc9f0' },
  { id: 29, x: 54, width: 11, z: 174, height: 22, color: '#adb5bd', windows: win([false, true, false, true]), roofLandable: true, enterable: false },
  { id: 30, x: 230, width: 10, z: 54, height: 12, color: '#ffe3e3', windows: win([true, false, true, true]), roofLandable: true, enterable: true, shop: 'FIRE', shopColor: '#d62828' },
  { id: 31, x: 98, width: 8, z: 30, height: 11, color: '#f3e8ff', windows: win([true, true, false, false]), roofLandable: true, enterable: true, shop: 'TAILOR', shopColor: '#9b5de5' },
]
